...
class DatabaseTest {
    ...
    void deleteComponent() throws ProductNotFoundException {
        ...
        database.deleteComponent(5);
        assertEquals(10, database.getComponents().size());
        database.resetEntireDatabase();

    }
    @Test
    void increaseComponentStock() throws ProductNotFoundException {
        database.increaseComponentStock(0, 5);
        assertEquals(6, database.getComponents().get(0).getAmount());
        database.resetEntireDatabase();
    }
    @Test
    void decreaseComponentStock() throws ProductNotFoundException, OutOfStockException {
        database.increaseComponentStock(0, 5);
